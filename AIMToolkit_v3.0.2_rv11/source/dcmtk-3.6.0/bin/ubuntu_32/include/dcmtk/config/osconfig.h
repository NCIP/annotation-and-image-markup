...
#define CANONICAL_HOST_TYPE "i686-Linux"
...
#define DCMTK_PREFIX "./../bin/ubuntu_32/${BUILD_TYPE}"

/* Define the default data dictionary path for the dcmdata library package */
#define DCM_DICT_DEFAULT_PATH "./../bin/ubuntu_32/${BUILD_TYPE}/share/dcmtk/dicom.dic"
...
#define DEFAULT_CONFIGURATION_DIR "./../bin/ubuntu_32/${BUILD_TYPE}/etc/dcmtk/"

/* Define to the default support data directory (used by some applications) */
#define DEFAULT_SUPPORT_DATA_DIR "./../bin/ubuntu_32/${BUILD_TYPE}/share/dcmtk/"
