...
namespace aim_lib
{
	...
	{
	public:
	//	static OFDateTime DateTimeConvert(const time_t& timeIn);
	...
	//	static time_t DateTimeConvert(const OFDateTime& ofDateTimeIn);
		static DateTime DateTimeConvert(const OFDateTime& ofDateTimeIn);

	//	static time_t DateTimeConvert(const altova::DateTime& altovaDateTime);
	//	static altova::DateTime AIMUtil::DateTimeToAltovaDateTime(const time_t& timeIn);
		...
		//static OFDate DateConvert(const time_t& timeIn);
		//static time_t DateConvert(const OFDate& ofDateIn);
