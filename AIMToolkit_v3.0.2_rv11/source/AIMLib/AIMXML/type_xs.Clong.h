...
#ifndef _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_Clong
#define _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_Clong
...
{
public:
	AIMXML_EXPORT Clong(xercesc::DOMNode* const& init);
	AIMXML_EXPORT Clong(Clong const& init);
...
#endif // _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_Clong
