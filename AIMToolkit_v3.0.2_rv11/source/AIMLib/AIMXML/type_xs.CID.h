...
#ifndef _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_CID
#define _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_CID
...
{
public:
	AIMXML_EXPORT CID(xercesc::DOMNode* const& init);
	AIMXML_EXPORT CID(CID const& init);
...
#endif // _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_CID
