...
#ifndef _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_Cdate
#define _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_Cdate
...
{
public:
	AIMXML_EXPORT Cdate(xercesc::DOMNode* const& init);
	AIMXML_EXPORT Cdate(Cdate const& init);
...
#endif // _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_Cdate
