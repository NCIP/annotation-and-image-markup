...
#ifndef _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_ChexBinary
#define _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_ChexBinary
...
{
public:
	AIMXML_EXPORT ChexBinary(xercesc::DOMNode* const& init);
	AIMXML_EXPORT ChexBinary(ChexBinary const& init);
...
#endif // _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_ChexBinary
