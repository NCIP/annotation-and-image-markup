...
#ifndef _ALTOVA_INCLUDED_AIMXML_ALTOVA__ALTOVA_CimagingObservationType
#define _ALTOVA_INCLUDED_AIMXML_ALTOVA__ALTOVA_CimagingObservationType
...
class CimagingObservationType : public TypeBase
{
public:
	AIMXML_EXPORT CimagingObservationType(xercesc::DOMNode* const& init);
	AIMXML_EXPORT CimagingObservationType(CimagingObservationType const& init);
	void operator=(CimagingObservationType const& other) { m_node = other.m_node; }
	static altova::meta::ComplexType StaticInfo() { return altova::meta::ComplexType(types + _altova_ti_altova_CimagingObservationType); }
	MemberElement<CImagingObservation, _altova_mi_altova_CimagingObservationType_altova_ImagingObservation> ImagingObservation;
...
#endif // _ALTOVA_INCLUDED_AIMXML_ALTOVA__ALTOVA_CimagingObservationType
