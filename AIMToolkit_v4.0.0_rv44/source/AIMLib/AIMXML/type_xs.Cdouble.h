...
#ifndef _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_Cdouble
#define _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_Cdouble
...
{
public:
	AIMXML_EXPORT Cdouble(xercesc::DOMNode* const& init);
	AIMXML_EXPORT Cdouble(Cdouble const& init);
...
#endif // _ALTOVA_INCLUDED_AIMXML_ALTOVA_xs_ALTOVA_Cdouble
