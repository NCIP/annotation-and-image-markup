    ...
    <div id="footer">
        <div class="wrapper">
        	<div id="main">
        		<br />
        		<br />
    			<a href="https://wiki.nci.nih.gov/display/AIM/AIM+Template+Service+User%27s+Guide#AIMTemplateServiceUser%27sGuide-RegisteringforacaGridAccount" target="_blank">How to Create a User Account</a> |
